...
export class ResultScene extends BaseScene {
    ...
    create() {
        ...
        const boxBorderColor = this.resultData.isVictory ? 0xf1c40f : 0xe74c3c;
        this.add.rectangle(width / 2, boxY, boxW, boxH, 0x11111a, 0.9)
            .setStrokeStyle(2, boxBorderColor)
            .setDepth(5);
        ...
        stats.forEach((stat, index) => {
            ...
            // Value (Right aligned)
            const valColor = index === 4 ? '#f1c40f' : (index === 3 ? (this.resultData.bossDefeated ? '#2ecc71' : '#e74c3c') : '#ffffff');
        ...
        // Button 1: PLAY AGAIN
        const playBtnBg = this.add.rectangle(width / 2 - 95, btnY, btnW, btnH, 0x27ae60)
        ...
        playBtnBg.on('pointerover', () => {
            playBtnBg.setFillStyle(0x2ecc71);
            playBtnText.setScale(1.08);
            audio.playSFX(AudioKeys.BUTTON_HOVER);
        });
        playBtnBg.on('pointerout', () => {
            playBtnBg.setFillStyle(0x27ae60);
            playBtnText.setScale(1.0);
        });
        ...
        // Button 2: MAIN MENU
        const menuBtnBg = this.add.rectangle(width / 2 + 95, btnY, btnW, btnH, 0x2c3e50)
        ...
        menuBtnBg.on('pointerover', () => {
            menuBtnBg.setFillStyle(0x34495e);
            menuBtnText.setScale(1.08);
            audio.playSFX(AudioKeys.BUTTON_HOVER);
        });
        menuBtnBg.on('pointerout', () => {
            menuBtnBg.setFillStyle(0x2c3e50);
